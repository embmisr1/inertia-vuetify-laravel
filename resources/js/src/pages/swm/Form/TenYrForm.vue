                        ...
                        <div class="space-y-4">
                            ...
                            >
                                ...
                                >
                                    <b-table
                                        ...
                                        :current-page.sync="
                                            ten_year_monitoring_list.current_page
                                        "
                                    ...
                                    >
                                        ...
                                        >
                                            <Link
                                                :href="`/app/swm/ten_year_monitoring_edit/${props.row.id}`"
                                            >
                                                <box-icon
                                                    name="edit"
                                                    color="orange"
                            ...
                            <v-card v-if="attachments">
                                ...
                                <v-card-text class="grid grid-cols-2 gap-2">
                                    <ViewAttachements
                                        v-if="
                                            attachments.ten_yr_file.data.length
                                        "
                                        title="10 YEAR FILE Attachments"
                                        :attachments="
                                            attachments.ten_yr_file.data
                                        "
                                        :goTo="
                                            (url) => {
                                                goTo(url);
