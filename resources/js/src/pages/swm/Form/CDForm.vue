              ...
              <v-card>
                ...
                <v-card-text class="grid grid-cols-2 gap-2">
                  <v-dialog
                    ...
                    :return-value.sync="cd.cd_date_monitored"
                    persistent
                    width="290px"
                    dark
                  >
                    ...
                    <v-date-picker v-model="cd.cd_date_monitored" scrollable dark>
                      <v-spacer></v-spacer>
                      <v-btn text @click="monitored_calendar = false" dark>
                        Cancel
                      </v-btn>
                      <v-btn
                        text
                        @click="$refs.mon_dialog.save(cd.cd_date_monitored)"
                        dark
                      >
                        OK
                      </v-btn>
                  ...
                  >
                    ...
                    <v-date-picker v-model="cd.cd_date_closure" scrollable dark>
                      <v-spacer></v-spacer>
                      <v-btn text dark @click="closure_calendar = false"> Cancel </v-btn>
                      <v-btn text dark @click="$refs.dialog.save(cd.cd_date_closure)">
                        OK
                      </v-btn>
                    </v-date-picker>
                  </v-dialog>
