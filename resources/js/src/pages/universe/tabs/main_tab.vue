        ...
        -->
            <div v-if="ctr_file" class="grid grid-cols-6 gap-y-3 gap-x-3 mb-2">
                ...
                <MiniDashboard
                    ...
                    :dashboard_content_label="
                        ctr_file['monitoring'].content_label
                    "
                ...
                <MiniDashboard
                    ...
                    :dashboard_content_label="
                        ctr_file['complaint'].content_label
                    "
                        ...
                        <v-tabs vertical>
                            <v-tab>
                                <div class="flex flex-start text-left">
                                    <v-icon>mdi-information</v-icon>&nbsp; Basic
                                    Information
                                </div>
                            </v-tab>
                            <v-tab>
              ...
              -->
                            ...
                            <v-tab-item>
                                <LegalTab
                                    ...
                                    :has_permit="has_legal_complaint"
                                ></LegalTab>
                            </v-tab-item>
                            <!--
              <v-tab-item>
