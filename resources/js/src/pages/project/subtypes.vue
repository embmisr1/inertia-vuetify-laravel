<template>
    <DefaultLayout :access="access">
        <v-btn elevation="10" small @click="subTypeModal.active = true">
            <box-icon
                name="plus"
        ...
        >
            ...
            >
                ...
                <template v-slot="props">
                    {{ props.row.project_subtype_desc }}
                </template>
            </b-table-column>
            ...
            <b-table-column field="action" label="" sortable v-slot="props">
                ...
                >
                    <v-btn
                        small
                        icon
                        @click="add_specific_type_via_page(props.row, 'post')"
                    >
                ...
                <v-btn
                    small
                    icon
                    @click="set_project_sub_type(props.row, 'patch')"
                >
                    <box-icon
                        name="edit"
                        color="orange"
                ...
                <v-btn
                    icon
                    small
                    @click="set_project_sub_type(props.row, 'delete')"
                    ><box-icon
                        name="trash"
                        color="red"
                        animation="tada-hover"
...
export default {
    components: { DefaultLayout, SubType, SpecificType },
