<template>
    <DefaultLayout :access="access">
        <v-btn elevation="10" small @click="specificTypeModal.active = true">
            <box-icon
                name="plus"
        ...
        <b-table-column
            ...
            >
                ...
                <template v-slot="props">
                    {{ props.row.project_specific_type_desc }}
                </template>
            </b-table-column>
            <b-table-column
            ...
            >
                <template #searchable="props">
                    <b-input
                        v-model="filters.project_subtype_desc"
                        placeholder="Search..."
                        icon="magnify"
                        size="is-small"
                    />
                ...
                <template v-slot="props">
                    {{ props.row.project_subtype.desc }}
                </template>
            </b-table-column>
            ...
            <b-table-column field="action" label="" sortable v-slot="props">
                ...
                >
                    <v-btn
                        ...
                        icon
                        @click="
                            add_specific_sub_type_via_page(props.row, 'post')
                        "
                    >
                ...
                <v-btn small icon @click="set_project_specific_type(props.row, 'patch')">
                    <box-icon
                        name="edit"
                        color="orange"
                        animation="tada-hover"
                ...
                <v-btn icon small @click="set_project_specific_type(props.row, 'delete')"
                    ><box-icon
                        name="trash"
                        color="red"
                        animation="tada-hover"
        ...
        <SpecificType
            :modal="specificTypeModal"
            :close="specificTypeClose"
            :submit="submitProjectSpecificType"
            :loading="loading"
            @search="searchSubType"
            :items="project_subtype"
        />
        <SpecificSubType
...
import SpecificType from "../../components/Project/SpecificType.vue";
import SpecificSubType from "../../components/Project/SpecificSubType.vue";
export default {
    components: { DefaultLayout, SpecificType, SpecificSubType },
