...
class UniverseController extends Controller
{
    ...
    public function universe_dashboard(request $request,$firm_type)
    {
        // $firm_type = $request->firm_type;
        $query_registered_industries_lgu_only = null;
        ...
        $query_order_issued_1586 = DB::table('tbl_legal as a')->leftjoin('tbl_universe as b', 'a.universe_FK', '=', 'b.id')->where('b.un_type', $firm_type)->where('a.nov_compliance_status', '!=', 'Complied')->where('a.nov_order_number', '!=', '')->where('a.nov_law', 'like', '%PD 1586%')->whereNotNull('a.nov_order_number');
        $query_order_issued_8749 = DB::table('tbl_legal as a')->leftjoin('tbl_universe as b', 'a.universe_FK', '=', 'b.id')->where('b.un_type', $firm_type)->where('a.nov_compliance_status', '!=', 'Complied')->where('a.nov_order_number', '!=', '')->where('a.nov_law', 'like', '%RA 8749%')->whereNotNull('a.nov_order_number');
        $query_order_issued_9275 = DB::table('tbl_legal as a')->leftjoin('tbl_universe as b', 'a.universe_FK', '=', 'b.id')->where('b.un_type', $firm_type)->where('a.nov_compliance_status', '!=', 'Complied')->where('a.nov_order_number', '!=', '')->where('a.nov_law', 'like', '%RA 9275%')->whereNotNull('a.nov_order_number');
        $query_order_issued_6969 = DB::table('tbl_legal as a')->leftjoin('tbl_universe as b', 'a.universe_FK', '=', 'b.id')->where('b.un_type', $firm_type)->where('a.nov_compliance_status', '!=', 'Complied')->where('a.nov_order_number', '!=', '')->where('a.nov_law', 'like', '%RA 6969%')->whereNotNull('a.nov_order_number');
        $query_order_issued_9003 = DB::table('tbl_legal as a')->leftjoin('tbl_universe as b', 'a.universe_FK', '=', 'b.id')->where('b.un_type', $firm_type)->where('a.nov_compliance_status', '!=', 'Complied')->where('a.nov_order_number', '!=', '')->where('a.nov_law', 'like', '%RA 9003%')->whereNotNull('a.nov_order_number');
        ...
        return Inertia::render("pages/universe/universe_dashboard", [
            ...
            'query_registered_industries_lgu_only' => $query_registered_industries_lgu_only,
            ...
            'query_order_issued_1586' => $query_order_issued_1586->count(),
            'query_order_issued_8749' => $query_order_issued_8749->count(),
            'query_order_issued_9275' => $query_order_issued_9275->count(),
            'query_order_issued_6969' => $query_order_issued_6969->count(),
            'query_order_issued_9003' => $query_order_issued_9003->count(),
