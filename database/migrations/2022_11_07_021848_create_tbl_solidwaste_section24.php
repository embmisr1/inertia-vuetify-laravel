...
class CreateTblSolidwasteSection24 extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_solidwaste_section24', function (Blueprint $table) {
            ...
            $table->string('section24_basis_1')->nullable();
            $table->string('section24_basis_2')->nullable();
            $table->string('section24_basis_3')->nullable();
            $table->string('section24_basis_4')->nullable();
            $table->string('section24_basis_5')->nullable();
            $table->string('section24_basis_6')->nullable();
            $table->string('section24_basis_7')->nullable();
            $table->string('section24_basis_8')->nullable();
            $table->string('section24_basis_9')->nullable();
            $table->string('section24_basis_10')->nullable();
            $table->string('section24_basis_11')->nullable();
